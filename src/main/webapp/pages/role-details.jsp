    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/role/findAllList.do"> 角色列表</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab-user">
                            ...
                            <table
                                ...
                                <c:forEach items="${roleUserList}" var="roleUserList" varStatus="status">
                                    <tr>
                                            <%--                                        <td>--%>
                                            <%--                                            <input name="uid" value="${roleUserList.UId}" type="checkbox">--%>
                                            <%--                                        </td>--%>
                                        ...
                                        <td class="text-center">${roleUserList.user.UStatus}</td>
                                            ...
                                            <%--                                                    onclick="deleteRoleUser(${roleUserList.UId})">--%>
                                            <%--                                                删除--%>
                                            <%--                                            </button>--%>
                                            <%--                                        </td>--%>
                                    </tr>
