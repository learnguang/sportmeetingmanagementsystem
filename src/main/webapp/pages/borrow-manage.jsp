            ...
            <div class="box box-primary" id="display" style="display: none">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!--工具栏/-->
                        <!--数据列表-->
                        <form id="selection" action="${pageContext.request.contextPath}/borrow/deleteById.do"
                              method="post">
                            <!--数据列表-->
                            <table id="dataList"
                                ...
                                <c:forEach items="${borrow}" var="borrow">
                                    <tr>
                                        ...
                                        <td class="text-center">${borrow.BEndtimeStr.length() >0 ? borrow.BEndtimeStr:"未还" }</td>
                                        ...
                                        <td class="text-center">
                                                ...
                                                <%--                                                    onclick="location.href='${pageContext.request.contextPath}/equipment/findDetailsByeId.do?eId=${borrow.BEid}'">--%>
                                                <%--                                                详情--%>
                                                <%--                                            </button>--%>
                                                <%--                                            <button type="button" class="btn btn-info btn-xs" data-toggle="modal"--%>
                                                <%--                                                    data-target="#myModal" onclick="getBorrow(${borrow.BId})">修改--%>
                                                <%--                                            </button>--%>
                                            <button type="button"
                                                    class="btn bg-red btn-xs "
                                                    onclick="deleteBorrowById(${borrow.BId})">
                                                删除
                                            </button>
                                        </td>
                                    </tr>
...
<script>
    ...
    function deleteBorrowById(id) {
        if (confirm("您确定要删除吗？")) {
            location.href = '${pageContext.request.contextPath}/borrow/deleteById.do?id=' + id;
        }
    }
    ...
    $(document).ready(function () {
        ...
        // 激活导航位置
        setSidebarActive("borrow-manage");
