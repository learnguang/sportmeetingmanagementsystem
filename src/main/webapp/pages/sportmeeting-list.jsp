            ...
            <div class="box box-primary" style="display: none" id="display">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <form id="del" action="${pageContext.request.contextPath}/sportmeeting/deleteByPK.do"
                              method="post">
                            <!--数据列表-->
                            <table id="dataList"
                                ...
                                <c:forEach items="${sportmeeting}" var="spormeeting" varStatus="status">
                                    <tr>
                                        ...
                                        <td align="center"><span
                                                class=" label ${spormeeting.SStatus == false ? "label-danger":"label-success"} "> ${spormeeting.SStatus==false?"关闭":"正在开展中..."}</span>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs "
                                                    onclick="location.href='${pageContext.request.contextPath}/sportmeeting/findDetailsBysId.do?sId=${spormeeting.SId}'">
                                                详情
                                            </button>
                                        </td>
                                    </tr>
