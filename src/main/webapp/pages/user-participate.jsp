            ...
            <div class="box box-primary" id="display" style="display: none">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <form id="del" action="${pageContext.request.contextPath}/event/deleteByPK.do"
                              method="post">
                            <!--数据列表-->
                            <table id="dataList"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs "
                                                    onclick="location.href='${pageContext.request.contextPath}/event/findDetailsByeId.do?eId=${matches.event.EId}'">
                                                详情
                                            </button>
...
<script>
    ...
    function cancle(id) {
        if (confirm("你确定要退赛吗？")) {
            location.href = '${pageContext.request.contextPath}/matches/concle.do?id=' + id;
            alert("成功退赛！");
            location.reload();
        }
    }
